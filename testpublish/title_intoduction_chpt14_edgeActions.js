...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","mouseup",function(sym,e){window.open("Learning_objectives_chpt14.html","_self");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","mouseup",function(sym,e){window.open("discuss_introduction_chpt14.html","_self");});
//Edge binding end
})("navWithReplay");

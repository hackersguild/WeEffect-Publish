...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","mouseup",function(sym,e){});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","click",function(sym,e){window.open("milking_procedures_scene2.html","_self");});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","click",function(sym,e){window.open("milk_handling_scene1.html","_self");});
//Edge binding end
})("navWithReplay");

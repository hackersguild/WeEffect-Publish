...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","mouseup",function(sym,e){window.open("title_intoduction_chpt14.html","_self");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","mouseup",function(sym,e){window.open("introduction_scene1_chpt14.html","_self");});
//Edge binding end

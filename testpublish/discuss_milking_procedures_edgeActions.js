...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","mouseup",function(sym,e){window.open("title_milking_procedures.html","_self");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","mouseup",function(sym,e){window.open("milking_procedures_scene1.html","_self");});
//Edge binding end

...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","mouseup",function(sym,e){window.open("introduction_chp14_scene2.html","_self");});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_right}","mouseup",function(sym,e){window.open("discuss_milking_methods.html","_self");});
//Edge binding end
})("navWithReplay");

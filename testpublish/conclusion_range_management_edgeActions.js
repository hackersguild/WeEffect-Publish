...
//Edge symbol: 'navigation'
(function(symbolName){})("navigation_1");
//Edge symbol end:'navigation_1'
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_arrow_left}","mouseup",function(sym,e){window.open("title_conclusion_chp13.html","_self");});
//Edge binding end

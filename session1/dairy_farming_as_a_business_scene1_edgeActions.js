...
(function(symbolName){Symbol.bindElementAction(compId,symbolName,"${_Group}","click",function(sym,e){window.open("discuss_why_dairy_farming_is_a_business.html","_self")});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Group2}","click",function(sym,e){window.open("diary_farming_as_a_business_scene2.html","_self")});
//Edge binding end
})("navigation");

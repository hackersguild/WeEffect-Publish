...
(function(symbolName){Symbol.bindElementAction(compId,symbolName,"${_Group}","click",function(sym,e){window.open('dicuss_record_time.html','_self');});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Group2}","click",function(sym,e){window.open('ASSIGN.html','_self');});
//Edge binding end
})("navigation");
